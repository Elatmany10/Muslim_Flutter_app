...
class TasbehHome extends StatefulWidget {
  ...
  const TasbehHome({@required this.maxSlide});
...
class _TasbehHomeState extends State<TasbehHome> with TickerProviderStateMixin {
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => TasbehSectionDetailScreen(
              id: model.id,
              title: model.name,
            )));
      },
  ...
  loadSections() async {
    DefaultAssetBundle.of(context)
        .loadString("assets/database/tasbeh_db.json")
        .then((data) {
