...
class TasbehSectionDetailScreen extends StatefulWidget {
  final int id;
  final String title;
  const TasbehSectionDetailScreen({Key key ,  this.id ,  this.title}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _TasbehSectionDetailScreenState createState() => _TasbehSectionDetailScreenState();
}

class _TasbehSectionDetailScreenState extends State<TasbehSectionDetailScreen> {
  ...
  loadSectionDetail() async {
    ...
    DefaultAssetBundle.of(context)
        .loadString("assets/database/tasbeh_details_db.json")
        .then((data) {
