...
class AzkarHome extends StatefulWidget {
  ...
  const AzkarHome({@required this.maxSlide});
...
class _AzkarHomeState extends State<AzkarHome> with TickerProviderStateMixin {
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(
                  top: 180, right: 30, left: 30, bottom: 50),
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => AzkarSectionDetailScreen(
                  id: model.id,
                  title: model.name,
                )));
      },
