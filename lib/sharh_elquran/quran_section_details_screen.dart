...
class QuranSectionDetailScreen extends StatefulWidget {
  final int id;
  final String title;
  const QuranSectionDetailScreen({Key key ,  this.id ,  this.title}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _QuranSectionDetailScreenState createState() => _QuranSectionDetailScreenState();
}

class _QuranSectionDetailScreenState extends State<QuranSectionDetailScreen> {
  ...
  loadSectionDetail() async {
    ...
    DefaultAssetBundle.of(context)
        .loadString("assets/database/quran_details_db.json")
        .then((data) {
