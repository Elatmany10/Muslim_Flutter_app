...
import 'package:h_quran/view/sajdaAyahs_view.dart';
            ...
            FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Center(
                      child: Text(
                          "خطأ في الاتصال! يرجى التحقق من اتصالك"));
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("رقم السجدة: ${widget.sajdaNumber}"),
                Text("رقم الجزء: ${widget.juzNumber}"),
                Text("رقم الصفحة: ${widget.rukuNumber}"),
