...
import 'package:h_quran/widgets/arabic_quraan/bookmarks.dart';
    ...
    return Scaffold(
      ...
      body: FutureBuilder<PdfDocument>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return SafeArea(
              child: Container(),/*PdfView(
                scrollDirection: Axis.horizontal,
                document: snapshot.data,
                controller: PdfController(),
                pageBuilder: ( pageImage,document, isCurrentIndex) {
                  currentPage = pageImage.hashCode;
